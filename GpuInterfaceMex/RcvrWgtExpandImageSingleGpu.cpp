...
#include "math.h"
#include "string.h"
#include "CUDA_RcvrWgtExpandImage_v11a.h"
...
// Cuda           
//-------------------------------------
RcvrWgtExpandImage(GpuNum,HComplexMatrixGrid,HComplexMatrixRcvrProf,HComplexMatrixBase,MatSzGrid[0],MatSzBase[0],Inset[0],Error);
