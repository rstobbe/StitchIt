...
function [ExpPars,PanelOutput,err] = YafiHrd_v7k_SeqDat(MrProt,DataInfo)
...
ExpPars.Sequence.TrRatio = test1{25};
...
Panel(12,:) = {'','','Output'};
Panel(13,:) = {'Shift1 (mm)',ExpPars.shift(1),'Output'};
Panel(14,:) = {'Shift2 (mm)',ExpPars.shift(2),'Output'};
Panel(15,:) = {'Shift3 (mm)',ExpPars.shift(3),'Output'};
