...
function [ExpPars,PanelOutput,err] = Yfp2b_v2k_SeqDat(MrProt,DataInfo)
...
for n = 1:4
    ExpPars.Sequence.tr(n) = MrProt.alTR{n}/1e3;                       % in ms
    ExpPars.Sequence.te(n) = MrProt.alTE{n}/1e3;                        % in ms
end
...
ExpPars.Sequence.SarLookup = test1{25};
...
Panel(5,:) = {'TRs (ms)',ExpPars.Sequence.tr,'Output'};
Panel(6,:) = {'TEs (ms)',ExpPars.Sequence.te,'Output'};
m = 6;
