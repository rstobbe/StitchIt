...
function [ExpPars,PanelOutput,err] = YessHrd_v3k_SeqDat(MrProt,DataInfo)
...
ExpPars.Sequence.gsdur = test1{18};
ExpPars.Sequence.gsmag = test1{19};
ExpPars.Sequence.gsslew = test1{20};
...
Panel(12,:) = {'gsdur (us)',ExpPars.Sequence.gsdur,'Output'};
Panel(13,:) = {'gsmag (mT/m)',ExpPars.Sequence.gsmag,'Output'};
Panel(14,:) = {'gsslew (mT/m/ms)',ExpPars.Sequence.gsslew,'Output'};
% Panel(15,:) = {'','','Output'};
