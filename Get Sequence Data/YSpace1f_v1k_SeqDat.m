...
function [ExpPars,PanelOutput,err] = YSpace1f_v1k_SeqDat(MrProt,DataInfo)
...
ExpPars.Sequence.ref = cell2mat(test1(41:60));
...
Panel(8,:) = {'Refocus (degrees)',ExpPars.Sequence.ref,'Output'};
Panel(9,:) = {'','','Output'};
