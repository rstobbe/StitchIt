...
classdef ReconYvfaFbV2a < handle

properties (SetAccess = private)                   
    Method = 'ReconYvfaFbV2a'
    BaseMatrix
    AcqInfo
    AcqInfoRxp
    Rcvrs
...
% Constructor
%==================================================================  
function ReconObj = ReconYvfaFbV2a()              
...
function [Image,err] = CreateImage(ReconObj,DataObj)     
    ...
    for n = 1:NumFlips
        ...
        FirstDataPoints = FirstDataPoints0(TrajPerFlip*(n-1)+1:TrajPerFlip*n,:);
    ...
    for n = 1:NumFlips
        YvfaData(:,:,:,n) = DataFull(TrajPerFlip*(n-1)+1:TrajPerFlip*n,:,:);
    end
