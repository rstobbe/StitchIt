...
classdef ReconLungStitchItWaveletV1a < handle
...
% Constructor
%==================================================================  
function ReconObj = ReconLungStitchItWaveletV1a()              
...
function [Image,err] = CreateImage(ReconObj,DataObjArr)     
    ...
    %TrajMashInfo = TrajMashMinMax(FirstDataPoints,MetaData); 
    ...
    for n = 1:NumImages
        ...
        %%% RxProfs
        ReconObj.DispStatObj.Status(['RxProfs ',num2str(n)],2);
        Data = DoTrajMash(DataRxProfFull,WeightArr(:,n),DataObj0.NumAverages);
        ...
        %%% Initial Image
        ReconObj.DispStatObj.Status(['Initial Image ',num2str(n)],2);
        Data = DoTrajMash(DataFull,WeightArr(:,n),DataObj0.NumAverages);
        ...
        %%% StitchIt Recon
        ReconObj.DispStatObj.Status(['StitchIt Recon ',num2str(n)],2);
        StitchIt.LoadRxProfs(RxProfs);
        Image(:,:,:,n) = StitchIt.CreateImage(Data,Image0);
