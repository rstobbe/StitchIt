...
% Constructor
%==================================================================  
function ReconObj = ReconYafiV1b()              
...
function [Image,err] = CreateImage(ReconObj,DataObjArr)     
    ...
    for n = 1:length(DataObjArr)
        ...
        if ReconObj.UseExternalShift
            ...
            %Data = DataObjArr{n}.DataObj.ReturnYafiData(ReconObj.AcqInfoRxp,ReconObj.ReconNumber);
        end
        ...
        Image(:,:,:,:,n,3) = 180*acos((TrRat*ImRat-1)./(TrRat-ImRat))/pi;
