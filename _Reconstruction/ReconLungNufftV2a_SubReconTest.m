...
classdef ReconLungNufftV2a_SubReconTest < handle
...
% Constructor
%==================================================================  
function ReconObj = ReconLungNufftV2a_SubReconTest()              
...
function [Image,err] = CreateImage(ReconObj,DataObj)     
    ...
    %% SubSet Related  
    SubAcqs = ReconObj.Averages2Use * ReconObj.AcqInfo{ReconObj.ReconNumber}.NumTraj;
    ReconObj.AcqInfo{ReconObj.ReconNumber}.SetNumAverages(ReconObj.Averages2Use);
    ReconObj.AcqInfoRxp.SetNumAverages(ReconObj.Averages2Use);
    ReconObj.AcqInfo{ReconObj.ReconNumber}.SetTrajLocAllAcq(ReconObj.AcqInfo{ReconObj.ReconNumber}.TrajLocAllAcq(:,1:ReconObj.Averages2Use));
    ReconObj.AcqInfoRxp.SetTrajLocAllAcq(ReconObj.AcqInfo{ReconObj.ReconNumber}.TrajLocAllAcq(:,1:ReconObj.Averages2Use));   
    ...
    %--
    FirstDataPoints = FirstDataPoints(1:SubAcqs,:);
    %--
    ...
    %--
    DataFull = DataFull(1:SubAcqs,:,:);
    DataRxProfFull = DataRxProfFull(1:SubAcqs,:,:);
    %--
...
function SetAverages2Use(ReconObj,val)    
    ReconObj.Averages2Use = val;
end
