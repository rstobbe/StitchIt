...
classdef ReconLungNufftV1a < handle
...
% Constructor
%==================================================================  
function ReconObj = ReconLungNufftV1a()              
...
function [Image,err] = CreateImage(ReconObj,DataObjArr)     
    ...
    for nim = 1:NumImages
        ...
        Data = DoTrajMash(DataRxProfFull,WeightArr(:,nim),DataObj0.NumAverages);
        ...
        Data = DoTrajMash(DataFull,WeightArr(:,nim),DataObj0.NumAverages);
        Data = DataObj0.ScaleData(StitchIt,Data);
        Image(:,:,:,nim) = StitchIt.CreateImage(Data,RxProfs);
        ReconObj.DispStatObj.TestDisplayInitialImages(Image(:,:,:,nim),'');
