...
classdef NufftOffResFunctions < NufftOffResGpu
...
% Constructor
%==================================================================   
        function [obj] = NufftOffResFunctions()
            obj@NufftOffResGpu;
        end     
...
% Initialize
%==================================================================   
        function Initialize(obj,Nufft,KernHolder,AcqInfo,OffResMap,OffResTimeArr)
            ...
            obj.AllocateBaseHoldImageMatricesGpuMem;
            ...
            obj.LoadOffResMapGpuMem(OffResMap);
            obj.LoadOffResTimeArrGpuMem(OffResTimeArr);
...
%==================================================================           
        function FreeGpuMem(obj) 
            ...
            if not(isempty(obj.HBaseHoldImageMatrix))
                obj.FreeBaseHoldImageMatricesGpuMem;
            end  
            if not(isempty(obj.HRcvrProfMatrix))
                obj.FreeRcvrProfMatricesGpuMem;
            end 
            if not(isempty(obj.HOffResMap))
                obj.FreeOffResMapGpuMem;
            end  
            if not(isempty(obj.HOffResTimeArr))
                obj.FreeOffResTimeArrGpuMem;
            end  
