...
classdef StitchItReturnRxIms < handle
...
% Constructor
%==================================================================   
        function [obj] = StitchItReturnRxIms()
...
% CreateImage
%==================================================================         
        function RxIms = CreateImage(obj,Data)
            DisplayStatusCompass('Create Low Resolution Images',3); 
